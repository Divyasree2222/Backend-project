...
const updateUserCoverImage = asyncHandler(async (req, res) => {
  ...
  const oldCoverImageUrl = req.user?.coverImage; // Store old URL before updating
...
const getUserChannelProfile = asyncHandler(async(req, res) => {
  ...
  const channel = await User.aggregate([
    ...
    {
      $lookup: {
        from: "subscriptions",        //in db Subscription is stored like this
        localField: "_id",
        foreignField: "channel",
        as: "subscribers"
      }
    },
    //no.of channels subscribed
    {
      $lookup: {
        from: "subscriptions",
        localField: "_id",
